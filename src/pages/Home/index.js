...
const Page = () => {
  ...
  // const {last} = useData()
  const { data } = useData();
  const lastPresta = data?.events?.sort((a, b) => new Date(b.date) - new Date(a.date))[0];
  ...
  return <>
    ...
    <main>
      ...
      <section className="ServicesContainer">
        <h2 className="Title" id="nos-services">Nos services</h2> {/* rajout ancre */}
      ...
      <section className="EventsContainer">
        <h2 className="Title" id="nos-realisations">Nos réalisations</h2> {/* rajout ancre */}
        <EventList />
      </section>
      <section className="PeoplesContainer">
        <h2 className="Title" id="notre-equipe">Notre équipe</h2> {/* rajout ancre */}
    ...
    <footer className="row">
      <div className="col presta">
        ...
        /> */}
          {lastPresta && (
          <EventCard
            imageSrc={lastPresta.cover}
            title={lastPresta.title}
            date={new Date(lastPresta.date)}
            small
            label="boom"
          />
        )}
